    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            <div class="app-brand demo">
              ...
              <span class="app-brand-logo demo">
                ...
                -->
                    ...
                    <span class="app-brand-text demo menu-text fw-bolder ms-2">ZillaStock</span>
                </a>
            ...
            <ul class="menu-inner py-1">
                ...
                <!-- managing accounts types -->
                <li class="menu-item">

                        <li class="menu-item">
                            <a href="../Admin/ImageCategory/" class="menu-link">
                                <div data-i18n="Without navbar">Manage Image Category</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="#" class="menu-link">
                                <div data-i18n="Container">Manage images</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="#" class="menu-link">
                                <div data-i18n="Fluid">Manage payments</div>
                            </a>
                        </li>
                ...
                <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <div data-i18n="Account Settings">Users list</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="#" class="menu-link">
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        ...
                        <li class="menu-item">
                            <a href="#" class="menu-link">
                                <div data-i18n="Connections">empty</div>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <div class="row"> -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4 order-0 mb-4">
                            <div class="card h-fluid">
                                <div class="card-header d-flex align-items-center justify-content-between pb-0">
                                    <div class="card-title mb-0">
                                        <h5 class="m-0 me-2">Website Statistics</h5>
